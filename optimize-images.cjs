...
console.log("   - hero-about.webp (5.9MB) → hero-about.webp (~1.5MB)");
console.log("   - building-tech.webp (5.5MB) → building-tech.webp (~1.4MB)");
console.log("   - designing-for.webp (5.7MB) → designing-for.webp (~1.4MB)");
console.log(
  "   - diriving-change.webp (6.2MB) → diriving-change.webp (~1.5MB)"
);
console.log("");
