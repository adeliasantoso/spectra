...
import isabellaMontoyaImg from "../assets/images/product-page/testimonial/isabella-montoya.webp";
import jamesAlbrightImg from "../assets/images/product-page/testimonial/james-albright.webp";
import jordanCarterImg from "../assets/images/product-page/testimonial/jordan-carter.webp";
import chloeChenImg from "../assets/images/product-page/testimonial/chloe-chen.webp";
import sarahMyersImg from "../assets/images/product-page/testimonial/sarah-myers.webp";
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            {!product
              ...
              : "Only Spectra 1.0 details are available at this time."}
          </p>
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review:
        "We tried to find an interior designer for our house, but it was hard because we live in a small town. Spectra gave us some good options, and soon after, we hired someone from that list.",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "I always dread those weekly grocery runs. Now, fresh stuff just shows up at my door on weekends. Spectra did all the heavy lifting for me.",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "My friends and I run a small pottery business, and honestly, Spectra feels like our unofficial team member. It's always coming up with cool ideas and showing us helpful tools to buy.",
    ...
    },
    {
      ...
      rating: 5,
      review:
        "These days, I trust Spectra to pick and shop new outfits for me and those clothes actually fit my vibe! I like the way I look now.",
      avatar: chloeChenImg,
      date: "April 8, 2025",
    },
    {
      ...
      rating: 5,
      review:
        "I've always wanted to start investing but didn't know where to start. Spectra recommended a great app to help me grow my saving. Nine months in, and I'm actually seeing progress.",
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (
        ...
        scrollPosition >= specificationsRef.current.offsetTop
      ) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
                ...
                >
                  <OptimizedImage
                    ...
                    className={`w-full h-full ${
                      index === 1 ? "object-cover p-0" : "object-contain p-2"
                    }`}
                    lazy={true}
                  />
                </button>
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-base md:text-lg font-semibold w-12 text-center transition-all duration-200">
                  {quantity}
                </span>
                <button
        ...
        >
          ...
          <div
            className={`bg-white rounded-2xl shadow-sm p-8 transition-all duration-700 delay-200 ${
              visibleSections.has("description-section")
                ? "animate-fade-up opacity-100"
                : "opacity-100"
            }`}
                ...
                {product.id === "spectra-1-0" ? (
                  <>
                    ...
                    <p className="text-lg md:text-xl">
                      ...
                      enhances your experience across work, leisure, and
                      everything in between. By learning from your habits,
                      Spectra 1.0 offers insights and suggestions tailored to
                      your preferences and environment. Supported by our
                      powerful AI model, it presents what matters, exactly when
                      you need it. Expand your universe with Spectra 1.0.
                    </p>
                    ...
                    {isDescriptionExpanded && (
                      ...
                      >
                        <p className="text-base md:text-lg">
                          ...
                          on, what you skip, and turns that awareness into
                          moment-to-moment relevance. More than just a device,
                          it's an intelligent companion that learns from you to
                        ...
                        <p className="text-base md:text-lg">
                          ...
                          Whether you're navigating a busy day or winding down
                          in the evening, Spectra acts as your reliable,
                          ever-present assistant. It processes your preferences
                          to generate thoughtful, timely suggestions, from
                          recommending what to watch next to guiding you toward
                          smarter purchases.
                        </p>
                        ...
                        <p className="text-base md:text-lg">
                          ...
                          most. This enables Spectra 1.0 to help you discover
                          the right product, service, or spark of inspiration,
                          often before you even think to ask. With intuitive
                          controls and seamless connectivity, Spectra 1.0 offers
                          a more intelligent way to engage with the world around
                          you.
                        </p>
                        ...
                        <p className="text-base md:text-lg">
                          ...
                          syncing or third-party access. It stores only what's
                          necessary and learns solely for your benefit. Spectra
                          1.0 is equipped with intelligence and care to enrich
                          your world.
                        </p>
                  ...
                  <>
                    ...
                    <p className="text-base md:text-lg">
                      Spectra Buds redefines your relationship with sound. These
                      next-generation wireless earbuds adapt intelligently to
                      your environment, delivering rich, spatial audio that
                      shifts seamlessly with your day from focus to movement,
                      from silence to cityscape.
                    </p>
                    ...
                    {isDescriptionExpanded && (
                      ...
                      >
                        <p className="text-base md:text-lg">
                          They don't just play what you love; they understand
                          how you listen. By detecting ambient noise, your
                          movement, and even your routine, Spectra Buds tailor
                          their output in real time to suit the moment whether
                          you're deep in work mode, on a call, or simply
                          unwinding.
                        </p>

                        <p className="text-base md:text-lg">
                          Spectra Buds were created from a vision that audio
                          should respond, not interrupt. Rather than forcing you
                          to adapt, they tune themselves around you letting
                          sound become a natural extension of how you live.
                        </p>

                        <p className="text-base md:text-lg">
                          The transitions feel almost invisible. As you leave a
                          quiet café and step into the street, the earbuds
                          automatically shift to prioritize clarity and
                          awareness. During commutes, they balance immersive
                          sound with the outside world. In every shift, Spectra
                          Buds know what you need to hear and what you don't.
                        </p>

                        <p className="text-base md:text-lg">
                          Designed to work in harmony with your Spectra devices,
                          audio follows you fluidly between contexts. Take a
                          call on your Watch, continue on your Vision glasses
                          without ever losing clarity or connection.
                        </p>

                        <p className="text-base md:text-lg">
                          With smart charging, adaptive battery modes, and
                          intuitive gestures, Spectra Buds disappear into your
                          flow. No friction, just fidelity.
                        </p>
                  ...
                  <>
                    <p className="text-base md:text-lg font-medium">
                      <strong>
                        Entertainment that adjusts to your household.
                      </strong>
                    </p>

                    <p className="text-base md:text-lg">
                      Spectra Display brings intelligent personalization to the
                      heart of your home. More than a smart TV, it's a shared
                      interface that learns the rhythms, tastes, and moments
                      that make your family unique and curates an experience to
                      reflect them.
                    </p>
                    ...
                    {isDescriptionExpanded && (
                      ...
                      >
                        <p className="text-base md:text-lg">
                          Every member of the household is recognized instantly.
                          Spectra adjusts content suggestions, brightness, even
                          sound profiles based on who's watching and when.
                          Parents catch up on the news in the morning, kids jump
                          into animation in the afternoon, and everyone winds
                          down together in the evening with content tuned to
                          shared interests.
                        </p>

                        <p className="text-base md:text-lg">
                          This isn't just entertainment it's attunement. Spectra
                          Display adapts the room's lighting, balances volume
                          dynamically based on seating patterns, and even offers
                          subtle wellness cues for screen time awareness.
                        </p>

                        <p className="text-base md:text-lg">
                          We designed Spectra Display with one question in mind:
                          Can a screen feel more like part of the family? The
                          answer is in how it listens, responds, and gently
                          organizes your digital world around your home's real
                          life.
                        </p>

                        <p className="text-base md:text-lg">
                          Integrated reminders, seamless calendar sync, and
                          ambient information make Spectra Display a central hub
                          not just for watching, but for living.
                        </p>
                  ...
                  <>
                    ...
                    <p className="text-base md:text-lg">
                      Spectra Watch transforms the way you engage with health
                      and productivity. More than tracking steps and stats, it
                      learns the unique patterns of your body and schedule,
                      offering insights that are not only personalized but
                      predictive.
                    </p>
                    ...
                    {isDescriptionExpanded && (
                      ...
                      >
                        <p className="text-base md:text-lg">
                          Rather than giving you generic goals, Spectra Watch
                          recognizes what balance looks like for you. It
                          identifies subtle deviations like rising stress levels
                          before you feel them, or changes in sleep before they
                          impact your energy. It guides with just the right
                          nudge, at just the right time.
                        </p>

                        <p className="text-base md:text-lg">
                          Built to flow with your day, Spectra Watch adapts how
                          it operates. On work-heavy days, it highlights focus
                          tools and meetings. During downtime, it leans into
                          fitness, recovery, and mindfulness. This isn't a
                          feature list it's a companion calibrated to your
                          intent.
                        </p>

                        <p className="text-base md:text-lg">
                          Spectra Watch was born from the belief that wellness
                          shouldn't be reactive. By sensing, interpreting, and
                          adapting, it brings intelligence to your wrist not to
                          overwhelm, but to support.
                        </p>

                        <p className="text-base md:text-lg">
                          In sync with your other Spectra devices, Watch extends
                          its insights across your ecosystem: visualize heart
                          rate trends on Display, receive workout cues in
                          Vision, or review recovery recommendations with Buds
                          on.
                        </p>

                        <p className="text-base md:text-lg">
                          Data stays where it belongs: with you. On-device
                          learning and encrypted processing ensure privacy by
                          default, not as an afterthought.
                        </p>

                        <p className="text-base md:text-lg font-medium text-left pt-6">
                          <em>
                            The better you know yourself, the better you move
                            through the world.
                          </em>
                        </p>
                      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {Object.entries(product.specifications).map(
                ([key, value], index) => (
                  <div
                    key={key}
                    className="flex flex-col space-y-3 p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all duration-300 hover:shadow-md"
                  >
                    <dt className="font-semibold text-gray-800 text-base md:text-lg">
                      {key}
                    </dt>
                    <dd className="text-gray-600 text-base md:text-lg leading-relaxed">
                      {value}
                    </dd>
                  </div>
                )
      ...
      >
        <div className="max-w-6xl mx-auto px-6 md:px-8 lg:px-12">
          <h2
            className={`text-xl md:text-2xl font-bold text-gray-900 mb-12 text-center transform transition-all duration-1000 ease-out ${
                ...
                >
                  <div
                    className={`aspect-square overflow-hidden ${
                      relatedProduct.id === "spectra-buds" ||
                      relatedProduct.id === "spectra-watch"
                        ? "bg-white"
                        : "bg-gray-100"
                    }`}
                  >
                    <OptimizedImage
                      ...
                      className={`w-full h-full transition-transform duration-500 ${
                        relatedProduct.id === "spectra-1-0"
                          ...
                          : relatedProduct.id === "spectra-display"
                          ? "object-cover scale-110 group-hover:scale-115"
                          : relatedProduct.id === "spectra-buds" ||
                            relatedProduct.id === "spectra-watch"
                          ? "object-contain p-16 group-hover:scale-105"
