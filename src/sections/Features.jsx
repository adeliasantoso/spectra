...
import expandTheUniverseAndCancelTheUnwanted from '../assets/images/landing-page/expandtheuniverseandcanceltheunwanted.png';
import unlockLifeAndLookThrough from '../assets/images/landing-page/unlocklifeandlookthrough.png';

const Features = () => {
  const features = [
    {
      title: "Expand your universe.",
      description: "Through seamless integration with all platforms on your devices, Spectra builds tailored recommendations that reflect your deepest inner thoughts.\n\nWhether it's for places or foods, for entertainment or productivity, every suggestion is customized to your needs.",
    ...
    },
    {
      ...
      description: "Powered with our latest AI model, Spectra uses multimodal sensory information to help you break barriers.\n\nFrom geospatial spaces to every day conversations, navigate your world with our intuitive insights.",
    ...
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="space-y-0 relative z-10">
        {features.map((feature, index) => {
          const yOffset = useTransform(scrollY, [index * 800, (index + 1) * 800], [50, -50]);
            ...
            >
              ...
              <div className="max-w-7xl mx-auto relative z-10">
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center ${
                  ...
                  {/* XR Image Card */}
                  <motion.div 
                    className={`${feature.layout === 'right' ? 'lg:col-start-2' : ''} overflow-hidden`}
                    initial={{ opacity: 0, x: feature.layout === 'right' ? 100 : -100 }}
                    ...
                    >
                      <div className="relative overflow-hidden rounded-2xl">
                        ...
                        <LazyImage
                          ...
                          style={{ minHeight: '500px', maxHeight: '800px', aspectRatio: '4/3' }}
                        />
                  ...
                  <motion.div 
                    className={`${feature.layout === 'right' ? 'lg:col-start-1 lg:row-start-1' : ''} space-y-8`}
                    initial={{ opacity: 0, x: feature.layout === 'right' ? -100 : 100 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true, margin: "-150px" }}
                  ...
                  >
                    ...
                    <div className={`text-xl md:text-2xl ${feature.textColor} leading-relaxed space-y-6 font-light`}>
                      {feature.description.split('\n\n').map((paragraph, pIndex) => (
                        <motion.p 
                          ...
                          viewport={{ once: true }}
                          transition={{ delay: 0.4 + pIndex * 0.1, duration: 0.6 }}
                        >
                          {paragraph}
                        </motion.p>
                      ))}
